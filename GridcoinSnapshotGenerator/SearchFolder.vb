...
Public Class SearchFolder
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If String.IsNullOrEmpty(ListBox1.SelectedItem) Then
            ...
            Form1.DriveFolderID = TextBox2.Text
            My.Settings.UploadFolder = TextBox1.Text
            My.Settings.UploadFolderID = TextBox2.Text
        Else
            Form1.TextBox2.Text = ListBox1.SelectedItem
            Form1.DriveFolderID = FolderIdsListBox.Items.Item(ListBox1.SelectedIndex)
            My.Settings.UploadFolder = ListBox1.SelectedItem
            My.Settings.UploadFolderID = FolderIdsListBox.Items.Item(ListBox1.SelectedIndex)
        End If
        My.Settings.Save()
        Me.Close()
    End Sub
